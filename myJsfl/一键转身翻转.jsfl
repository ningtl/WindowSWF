...
// C:\Users\tiang\AppData\Local\Adobe\Animate 2024\zh_CN\Configuration\Commands
//1.获取文档级别变量
var doc = fl.getDocumentDOM();// 获取文档变量，  也可用an。get。。（） 但是不知道却别
var timeline = doc.getTimeline(); // 获取当前的 时间轴对象、
var selection = doc.selection;// 获取当前选中的 对象 数组

//这些是你需要确定的  翻转总共需要多少帧完整动作
